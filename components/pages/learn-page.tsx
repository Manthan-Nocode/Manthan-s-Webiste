...
export default function LearnPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        window.gtag?.("event", "learn_content_loaded", {
          content_type: "blog_posts",
          content_count: posts.length,
        })
      } catch (err) {
  ...
  const handleTabChange = (value: string) => {
    ...
    // Track tab change
    window.gtag?.("event", "learn_tab_change", {
      tab: value,
    })
  }
    ...
    <main className="flex min-h-screen flex-col items-center">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CollectionPage",
            name: "Learning Resources | AI & Automation",
            description:
              "Explore our comprehensive library of resources on business automation, AI implementation, and no-code solutions.",
            url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://your-domain.com"}/learn`,
            isPartOf: {
              "@type": "WebSite",
            ...
            about: {
              "@type": "Thing",
              name: "Business Automation and AI Implementation",
            },
            offers: {
              "@type": "Offer",
      ...
      <div className="w-full bg-gradient-to-r from-blue-50 to-indigo-50 pt-28 pb-16 px-4 relative">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button onClick={() => handleTabChange("blogs")} className="bg-blue-600 hover:bg-blue-700 px-6">
            ...
            <Button
              ...
              onClick={() => {
                ...
                window.gtag?.("event", "waitlist_section_navigation", {
      ...
      <section className="w-full py-12 px-4 bg-white">
        <div className="container mx-auto">
          <Tabs defaultValue="blogs" value={activeTab} onValueChange={handleTabChange} className="w-full">
            ...
            <TabsContent value="courses" className="w-full">
              <div className="bg-blue-50 rounded-lg p-8 text-center mb-8 border border-blue-100">
                <div className="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-sm">
                  <Lock className="h-8 w-8 text-blue-500" aria-hidden="true" />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <div className="bg-white p-4 rounded-lg shadow-sm flex items-center">
                    <Calendar className="h-5 w-5 text-blue-500 mr-3" aria-hidden="true" />
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm flex items-center">
                    <Clock className="h-5 w-5 text-blue-500 mr-3" aria-hidden="true" />
                    <div className="text-left">
            ...
            <TabsContent value="blogs" className="w-full">
              ...
              <div className="flex justify-center mt-10">
                <Button
                  ...
                  onClick={() => {
                    window.gtag?.("event", "load_more_articles_click")
                  }}
                >
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  <div className="md:w-2/3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      />
                      <Button
                        className="bg-blue-600 hover:bg-blue-700 whitespace-nowrap transition-all duration-300 hover:shadow-md"
                        onClick={() => {
                          window.gtag?.("event", "newsletter_subscribe_click", {
                            source: "learn_page",
                          })
                        }}
                      >
                  ...
                  <div className="md:w-1/3 flex justify-center">
                    <div className="bg-white p-6 rounded-full h-28 w-28 flex items-center justify-center shadow-md">
                      <Mail className="h-14 w-14 text-blue-500" aria-hidden="true" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <TabsContent value="videos" className="w-full">
              <div className="bg-blue-50 rounded-lg p-8 text-center mb-8 border border-blue-100">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto mb-6">
                  ...
                  advanced implementation techniques. Join our waitlist to be notified when our video content launches.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <div className="bg-white p-4 rounded-lg shadow-sm flex items-center">
                    <Calendar className="h-5 w-5 text-blue-500 mr-3" aria-hidden="true" />
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm flex items-center">
                    <Video className="h-5 w-5 text-blue-500 mr-3" aria-hidden="true" />
                    <div className="text-left">
